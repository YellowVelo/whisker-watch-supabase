...
24 tables in the `public` schema, introduced across migrations 0001–0038 (the original 21 span 0001–0017; `email_logs`, `resend_webhook_events`, and `email_suppressions` were added later, see below):
