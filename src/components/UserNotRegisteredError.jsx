    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-background">
      <div className="max-w-md w-full p-8 bg-card rounded-lg shadow-lg border border-border">
        <div className="text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 mb-6 rounded-full" style={{ background: 'rgba(244,199,107,0.15)' }}>
            <svg className="w-8 h-8" style={{ color: PALETTE.amber }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
