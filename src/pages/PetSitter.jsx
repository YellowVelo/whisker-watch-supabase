    ...
    <PageTransition>
      <div className="min-h-screen pb-28">
        <header className="px-4 flex items-center gap-3" style={{ paddingTop: 'calc(env(safe-area-inset-top) + 12px)' }}>
          <button onClick={() => navigate(-1)} aria-label="Back" className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(255,255,255,0.06)' }}>
            <ArrowLeft className="h-5 w-5 text-white" />
          </button>
          <div className="min-w-0">
            <h1 className="text-[28px] font-bold text-foreground">Pet Sitter</h1>
            <p className="text-[14px] text-white/45">Manage sitting periods and sitter access.</p>
          </div>
        </header>
