      ...
      <div className="min-h-screen pb-24">
        <header style={{ paddingTop: 'env(safe-area-inset-top)' }}>
          <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-3">
            ...
            <h1 className="font-serif text-[24px] truncate">{section ? section.title : 'Privacy Policy'}</h1>
          </div>
        </header>
          ...
          {section ? (
            <>
              {section.id !== PRIVACY_POLICY_LAST_UPDATED_SECTION.id && (
                <p className="text-[13px] text-white/40 mb-5">Last updated {PRIVACY_POLICY_LAST_UPDATED}</p>
              )}
