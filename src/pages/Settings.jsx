...
// have prominent homes of their own (Pet Sitter: Home; AI: the global Ask
// Wysker header action) rather than being buried in account-level Menu.
const MENU_ITEMS = [
  ...
  { key: 'about', to: '/about', icon: Info, iconClassName: 'text-fuchsia-300', iconBg: 'rgba(232,121,249,0.14)', title: 'About', subtitle: 'About Wysker Watch', event: 'menu_about_selected' },
